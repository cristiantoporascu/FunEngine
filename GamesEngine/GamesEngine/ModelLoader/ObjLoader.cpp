...
bool ObjLoader::loadOBJ(const char* path, std::vector<glm::vec3>& inputVertices,
	std::vector<glm::vec2>& inputUvs, std::vector<glm::vec3>& inputNormals/*, std::vector<unsigned int>& inputIndicesVertices*/)
{
